...
public class TabFragment extends Fragment
    ...
    public static TabFragment newInstance(int position, String title, int color, String url) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        tab = new Tab(getArguments().getString(TITLE), getArguments().getInt(COLOR), getArguments().getString(URL));
        tabView = null;
    }
