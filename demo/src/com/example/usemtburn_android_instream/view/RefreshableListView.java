package com.example.usemtburn_android_instream.view;
...
public class RefreshableListView extends ListView implements OnScrollListener {
    ...
    private void init(Context context) {
        headerRelativeLayout = (RelativeLayout) inflate(context,
    ...
    public void onRefreshComplete() {
        ...
        SimpleDateFormat format =new SimpleDateFormat("MMM dd, yyyy HH:mm:ss", java.util.Locale.getDefault());
